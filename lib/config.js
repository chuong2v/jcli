...
var configPath = process.env.NODE_CONFIG_PATH || path.resolve(homedir, ".jlient/config.json");
...
if (fs.existsSync(configPath)) {
  ...
  if (!fs.existsSync(path.resolve(homedir, ".jlient"))) {
    fs.mkdirSync(path.resolve(homedir, ".jlient"));
  }
  if (!fs.existsSync(path.resolve(homedir, ".jlient/notes"))) {
    fs.mkdirSync(path.resolve(homedir, ".jlient/notes"));
  }
